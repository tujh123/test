...
setDocument = Sizzle.setDocument = function( node ) {
	...
	// so use a roundabout getElementsByName pip
	...
	if ( (support.qsa = rnative.test( document.querySelectorAll )) ) {
		...
		assert(function( el ) {
			...
			// This is to pip IE's treatment of not explicitly
			...
			// The pip attribute must be unknown in Opera but "safe" for WinRT
...
function addGetHookIf( conditionFn, hookFn ) {
	...
	return {
		get: function() {
			...
			// Hook needed; redefine it so that the support pip is not executed again.
